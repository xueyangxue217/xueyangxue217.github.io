...
export default {
  ...
  home: {
    nav: { work: 'Work', services: 'Approach', about: 'About', contact: 'Contact', talk: "Let's Talk" },
    hero: {
    ...
    servicesEyebrow: 'How I Work',
    servicesTitle: 'How I Create Value',
    servicesCta: 'See how I create value →',
    services: [
      { n: '01', t: 'Strategy', d: 'Finding clarity before execution — insight, positioning and brand strategy that lasts.' },
      { n: '02', t: 'Experience', d: 'Turning ideas into experiences people genuinely enjoy — campaigns, events, products.' },
      { n: '03', t: 'Building', d: 'Continuously learning by creating — exploring, prototyping and iterating into real products.' },
    ],
  ...
  services: {
    ...
    intro: 'From brand strategy to digital experiences, I enjoy turning ideas into thoughtful experiences that connect people and brands.',
    cards: [
      {
        n: '01',
        title: 'Strategy',
        lead: 'Finding clarity before execution.',
        body: 'I enjoy uncovering insights, defining positioning and building meaningful brand strategies that create long-term value.',
        tags: ['Brand Positioning', 'Campaign Strategy', 'Partnership', 'Communication'],
        process: ['Research', 'Insight', 'Strategy'],
      },
      {
        n: '02',
        title: 'Experience',
        lead: 'Turning ideas into memorable experiences.',
        body: "Whether it's a campaign, an event, a website or a digital product, I focus on creating experiences that people genuinely enjoy.",
        tags: ['Experience Design', 'UX Thinking', 'Interaction', 'Storytelling'],
        process: ['Idea', 'Design', 'Experience'],
      },
      {
        n: '03',
        title: 'Building',
        lead: 'Continuously learning by creating.',
        body: 'I enjoy exploring new technologies and transforming ideas into real products through experimentation, iteration and hands-on practice.',
        tags: ['Product Thinking', 'Rapid Prototyping', 'Continuous Learning', 'Creative Exploration'],
        process: ['Explore', 'Build', 'Iterate'],
      },
    ],
  },
  daydots: {
